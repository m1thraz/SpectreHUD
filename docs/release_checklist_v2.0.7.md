...
- [x] Review, commit, and push the prepared v2.0.7 release state.
- [x] Confirm the GitHub CI matrix and CodeQL complete successfully.
- [x] Create the annotated v2.0.7 tag from the verified commit and push it.
...
- [x] Confirm the GitHub release description links to docs/release_notes_v2.0.7.md.
