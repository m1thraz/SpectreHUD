...
.report-header-metadata thead {
    display: none;
}

.report-header-metadata tr:not(:last-child) td {
    border-bottom: 1px solid rgba(48, 54, 61, 0.4);
}

.report-header-metadata td {
    padding: 8px 14px;
    border-top: 0;
    border-left: 0;
    border-right: 0;
...
.report-header-metadata td:first-child {
    color: var(--text-muted);
    font-size: 11px;
...
.report-header-metadata td:last-child {
    color: var(--text-main);
    font-size: 13px;
    font-weight: 600;
}

.report-header-metadata td:last-child code {
...
.report-header-metadata table { border-left-color: #0969da; box-shadow: 0 4px 12px rgba(31, 35, 40, 0.08); }
.report-header-metadata td:last-child code { background-color: #ddf4ff; border-color: #54aeff; color: #0969da; }
.report-header-metadata tr:not(:last-child) td { border-bottom-color: #d0d7de; }
"""
...
body[data-report-profile="professional_print"] a.finding-reference {
    color: inherit;
    text-decoration: none;
}

body[data-report-profile="professional_print"] a.finding-reference:visited {
    color: inherit;
}
...
body[data-report-profile="professional_print"] .findings-matrix td:nth-child(1) {
    width: 10%;
    white-space: nowrap;
}
body[data-report-profile="professional_print"] .findings-matrix th:nth-child(2),
body[data-report-profile="professional_print"] .findings-matrix td:nth-child(2) { width: 42%; }
