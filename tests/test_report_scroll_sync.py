...
class TestReportScrollSync(unittest.TestCase):
    def setUp(self):
        ...
        self.mock_rfm.load.return_value = "# Large Document\n\n" + "\n\n".join(
    ...
    def test_scroll_sync_editor_to_preview(self):
        ...
        ed_bar = self.tab.workspace_shell.editor.verticalScrollBar()
        pr_bar = self.tab.workspace_shell.preview.verticalScrollBar()
