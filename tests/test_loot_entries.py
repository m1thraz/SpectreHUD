...
from core.loot import LootLimitError, LootManager, LootValidationError
...
class TestLootManager(unittest.TestCase):
    ...
    def test_report_roles_are_persisted_and_assigned_atomically(self):
        ...
        roles = {entry["id"]: entry["report_role"] for entry in self.loot_mgr.get_all_entries()}
    ...
    def test_report_role_assignment_rolls_back_on_persistence_failure(self):
        primary = self.loot_mgr.add_entry("note", "Primary", "Details", report_role="evidence")
