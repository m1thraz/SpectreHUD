"""Curated, portable font stacks used by SpectreHUD styles and reports."""

UI_FONT_STACKS = {
    "segoe_ui": "'Segoe UI', 'SF Pro Display', -apple-system, BlinkMacSystemFont, Roboto, sans-serif",
...
REPORT_FONT_STACKS = {
    "segoe_ui": "'Segoe UI', -apple-system, BlinkMacSystemFont, 'Inter', 'Roboto', 'Helvetica Neue', Arial, sans-serif",
    "calibri": "'Calibri', 'Segoe UI', Arial, sans-serif",
    "arial": "Arial, 'Helvetica Neue', 'Segoe UI', sans-serif",
    "georgia": "Georgia, 'Times New Roman', serif",
}

UI_FONT_OPTIONS = [("segoe_ui", "Segoe UI"), ("inter", "Inter"), ("roboto", "Roboto"), ("open_sans", "Open Sans")]
