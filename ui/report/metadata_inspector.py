...
class ReportMetadataInspector(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self.lbl_title = QLabel(
            t("report.inspector_metadata_title", "Report Metadata & Parameters")
        )
        ...
        form_layout.addRow(
            self._make_label(t("report.meta_title", "Report Title:")), self.txt_title
        )
        ...
        form_layout.addRow(
            self._make_label(t("report.meta_client", "Client / Organization:")), self.txt_client
        )
        ...
        form_layout.addRow(
            self._make_label(t("report.meta_tester", "Lead Tester / Analyst:")), self.txt_tester
        )
        ...
        form_layout.addRow(
            self._make_label(t("report.meta_scope", "Target / Scope:")), self.txt_scope
        )
        ...
        form_layout.addRow(
            self._make_label(t("report.meta_timeframe", "Assessment Period:")), self.txt_timeframe
        )
        ...
        form_layout.addRow(
            self._make_label(t("report.meta_classification", "Classification:")),
            self.cmb_classification,
        )
        ...
        form_layout.addRow(
            self._make_label(t("report.meta_version", "Report Version:")), self.txt_version
        )
